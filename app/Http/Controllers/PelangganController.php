...
class PelangganController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pelanggan.index', ['activeMenu' => $activeMenu, 'page' => $page, 'nama' => $nama]);
    }
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($pelanggans)
            ...
            ->addColumn('aksi', function ($pelanggan) { 
                $btn = '<button onclick="modalAction(\'' . url('/admin/pelanggan/' . $pelanggan->id_pelanggan . '/edit') . '\')" class="btn btn-warning btn-sm">Edit</button> ';

                $btn .= '<button onclick="modalAction(\'' . url('/admin/pelanggan/' . $pelanggan->id_pelanggan . '/delete') . '\')" class="btn btn-danger btn-sm">Hapus</button> ';
    ...
    public function confirm(string $id)
    {
        ...
        return view('admin.pelanggan.confirm', ['pelanggan' => $pelanggan]);
    }
